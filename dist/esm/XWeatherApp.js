import{_ as t,a as e}from"./_rollupPluginBabelHelpers-f13f2144.js";import{L as i,c as s,h as n}from"./lit-element-243fe127.js";import{P as r,h as o,a,d as l,u as h,D as c,b as d,e as p}from"./iron-flex-layout-8e8a6502.js";import"./mwc-button-30cf2617.js";import"./XWeatherHamburger.js";import"./utilities.js";import"./XWeatherBranding.js";import"./XWeatherBouncer.js";import{l as u,s as f,o as _}from"./dispatchers-5941fc5e.js";import"./XWeatherContent.js";import"./XWeatherDrawerChildren.js";
/**
@license
...
r({_template:o`
    ...
    <slot></slot>
`,is:"app-toolbar"});class v extends i{static get styles(){return s(S())}static get properties(){return{appid:{reflect:!1,type:String},host:{reflect:!0,type:String},location:{reflect:!0,type:String},sitetitle:{reflect:!0,type:String},siteurl:{reflect:!0,type:String}}}_handleDrawerChange(t){var e=this.shadowRoot.querySelector("app-drawer");""!==e.getAttribute("opened")?e.setAttribute("opened",""):e.removeAttribute("opened")}_handleDrawerLocationStorage(t){var e=localStorage.getItem("x-weather-app-current-location");if(e===t)return e;try{localStorage.setItem("x-weather-app-current-location",t)}catch(t){console.error(t)}return t}_handleDrawerLocationChange(e){var i,s=this._handleDrawerLocationStorage(e);try{i=JSON.parse(s)}catch(t){i={},console.error(t)}u(t({},i)),f({appid:this.appid,host:this.host}),_({appid:this.appid,host:this.host})}_handleLocationStorageOnRender(t){var e=localStorage.getItem("x-weather-app-current-location");if(e!==t&&null!==e)return e;try{localStorage.setItem("x-weather-app-current-location",t)}catch(t){console.error(t)}return t}firstUpdated(){this.addEventListener("x-weather-drawer-change",t=>{this._handleDrawerChange(t)}),this.addEventListener("x-weather-drawer-children",t=>{var{detail:e}=t,i=JSON.stringify(e);this.setAttribute("location",i),this._handleDrawerLocationChange(i)})}render(){var t=this._handleLocationStorageOnRender(this.location);return t?n(m(),this.sitetitle,this.siteurl,this.appid,this.host,t):n(w())}}export{v as XWeatherApp};
